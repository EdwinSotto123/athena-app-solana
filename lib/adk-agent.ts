...
import { z } from "zod";
import { VaultState } from "./frax-service";
import { getActiveVaultService } from "./chain-router";
...
// Chain-agnostic backend: same `fraxService` name kept to minimize diff,
// but underlying impl is selected at runtime by `VITE_CHAIN`.
const fraxService = getActiveVaultService();
